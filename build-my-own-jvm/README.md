...
- **Bytecode Interpretation**: Execution of an expanding subset of JVM opcodes.
  ...
  - **Just-In-Time (JIT) Compilation**: A basic ARM64 JIT compiler that optimizes "hot" methods returning constant integers _or performing simple arithmetic with arguments_ into native machine code for faster execution.
...
- The JIT compiler is a "leaf JIT", currently only optimizing very simple methods involving `iload_0`, `iload_1`, `iadd`, and `ireturn`. It demonstrates the pipeline, not a full-featured JIT.
